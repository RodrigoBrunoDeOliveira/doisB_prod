...
/* harmony import */ var _components_main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/main-menu/main-menu.component */ "./app/components/main-menu/main-menu.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_20__["MainMenuComponent"]
            ],
            exports: [],
            imports: [
...
module.exports = ".awards {\n  padding: 50px 0; }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n    .awards {\n      background-image: url('bkg_01.png'); } }\n  .awards .awards-container {\n    padding: 0 15px; }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n      .awards .awards-container {\n        display: flex; } }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n      .awards .awards-container .awards-header {\n        width: 50%; } }\n  .awards .awards-container .awards-header .title {\n      font-size: 24px; }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n        .awards .awards-container .awards-header .title {\n          font-size: 26px; } }\n  .awards .awards-container .awards-header .subtitle {\n      font-size: 15px; }\n  .awards .awards-container .awards-header .awards-article {\n      margin-top: 30px; }\n  .awards .awards-container .awards-header .awards-article .awards-figure img {\n        max-width: 100%;\n        border-radius: 7px; }\n  .awards .awards-container .awards-body {\n      padding: 0 15px;\n      margin-bottom: 50px;\n      display: inline-block; }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n        .awards .awards-container .awards-body {\n          width: 50%; } }\n  .awards .awards-container .awards-body .awards-resume {\n        width: calc(100% / 2);\n        display: inline-block; }\n  @media (min-width: 768px) and (max-width: 1023px), (min-width: 1024px) {\n          .awards .awards-container .awards-body .awards-resume {\n            margin: 0 auto;\n            display: -ms-grid;\n            display: grid; } }\n  .awards .awards-container .awards-body .awards-resume.last-resume {\n          margin: 0 auto;\n          display: block; }\n  .awards .awards-container .awards-footer {\n      margin-bottom: 30px; }\n  .awards .awards-container .awards-footer .awards-button {\n        color: #FFF;\n        background-color: #c4956a;\n        display: table;\n        padding: 10px 30px;\n        font-size: 12px;\n        line-height: 1.5;\n        font-weight: 700;\n        letter-spacing: -.02em;\n        text-transform: uppercase;\n        cursor: pointer;\n        margin: 0 auto; }\n"
...
module.exports = "<!-- TODO: remover bordar no bottom -->\n<header class=\"main-header\">\n  <img src=\"../../../assets/images/logo.png\">\n  <h1>DOIS B</h1>\n\n  <!-- TODO: Fazer burguer menu e animação -->\n  <button class=\"menu-btn\" (click)=\"open = !open\">\n    <span class=\"first-bar\" [class.active]=\"open\"></span>\n    <span class=\"second-bard\" [class.active]=\"open\"></span>\n    <span class=\"third-bar\" [class.active]=\"open\"></span>\n  </button>\n</header>\n\n<app-main-menu [open]=\"open\"></app-main-menu>"
...
module.exports = ".main-header {\n  background-color: #232323;\n  width: 100%;\n  max-width: calc(100vw - 32px);\n  height: 48px;\n  display: flex;\n  padding: 16px;\n  position: fixed; }\n  .main-header img {\n    max-width: 20px;\n    max-height: 30px;\n    margin: auto 0; }\n  .main-header h1 {\n    color: #FFF;\n    font-size: 30px;\n    margin: auto 0 auto 16px; }\n  .main-header .menu-btn {\n    cursor: pointer; }\n  .main-header .menu-btn span {\n      border-bottom: 2px solid #FFF;\n      width: 35px;\n      display: block;\n      margin-bottom: 10px;\n      transition-duration: 1s; }\n  .main-header .menu-btn span.first-bar.active {\n        -webkit-transform: rotate(405deg) translate(7px, 9px);\n                transform: rotate(405deg) translate(7px, 9px); }\n  .main-header .menu-btn span.second-bard.active {\n        opacity: 0; }\n  .main-header .menu-btn span.third-bar.active {\n        -webkit-transform: rotate(-405deg) translate(8px, -11px);\n                transform: rotate(-405deg) translate(8px, -11px); }\n"
...
/***/ "./app/components/main-menu/main-menu.component.html":
/*!***********************************************************!*\
  !*** ./app/components/main-menu/main-menu.component.html ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "<nav class=\"main-menu\" [class.open]=\"open\">\n  <ul class=\"menu-list\">\n    <li class=\"menu-list-item\">Home</li>\n    <li class=\"menu-list-item\" (click)=\"scrolling('comments')\">About</li>\n    <li class=\"menu-list-item\">Team</li>\n    <li class=\"menu-list-item\">Portfolio</li>\n    <li class=\"menu-list-item\" routerLink=\".\" fragment=\"comments\">Contacts</li>\n  </ul>\n\n  <div class=\"menu-number\">\n    <i class=\"fas fa-mobile-alt\"></i>\n    <span>(41) 98418-6477</span>\n  </div>\n</nav>\n"

/***/ }),

/***/ "./app/components/main-menu/main-menu.component.scss":
/*!***********************************************************!*\
  !*** ./app/components/main-menu/main-menu.component.scss ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = ".main-menu {\n  background-color: #FFF;\n  position: fixed;\n  height: calc(100vh - 80px);\n  width: 40vw;\n  left: 0;\n  top: 80px;\n  transition-duration: 1s;\n  -webkit-transform: translateX(-100%);\n          transform: translateX(-100%); }\n  .main-menu.open {\n    -webkit-transform: translateX(0%);\n            transform: translateX(0%); }\n  .main-menu .menu-list {\n    font-size: 15px;\n    line-height: 24px;\n    font-weight: 400;\n    letter-spacing: -.02em;\n    margin: 15px 0; }\n  .main-menu .menu-list .menu-list-item {\n      padding: 7px 0 7px 12px;\n      margin-top: 4px; }\n  .main-menu .menu-list .menu-list-item:hover {\n        background-color: #c4956a;\n        color: #FFF; }\n  .main-menu .menu-list .menu-list-item:first-of-type {\n        margin: 0; }\n  .main-menu .menu-number {\n    font-size: 18px;\n    line-height: 1.44444;\n    font-weight: 500;\n    letter-spacing: -.02em;\n    color: #000;\n    padding: 0 12px;\n    display: flex; }\n  .main-menu .menu-number i {\n      font-size: 22px;\n      line-height: 1;\n      color: #C4C4C4;\n      margin: auto 0;\n      display: block; }\n  .main-menu .menu-number span {\n      margin: auto 0 auto 15px; }\n"

/***/ }),

/***/ "./app/components/main-menu/main-menu.component.ts":
/*!*********************************************************!*\
  !*** ./app/components/main-menu/main-menu.component.ts ***!
  \*********************************************************/
...
var MainMenuComponent = /** @class */ (function () {
    ...
    ], MainMenuComponent.prototype, "open", void 0);
    MainMenuComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-main-menu',
            template: __webpack_require__(/*! ./main-menu.component.html */ "./app/components/main-menu/main-menu.component.html"),
            styles: [__webpack_require__(/*! ./main-menu.component.scss */ "./app/components/main-menu/main-menu.component.scss")]
        })
    ], MainMenuComponent);
...
module.exports = "<section class=\"team\">\n  <div class=\"team-container\">\n    <h3 class=\"team-title\">our team</h3>\n    <h6 class=\"team-subtitle\">people begind our success</h6>\n\n    <article class=\"team-article\">\n      <div class=\"team-left\">\n        <div class=\"team-figure\">\n          <img *ngIf=\"screen === 'desktop'\" class=\"team-figure\" src=\"../../../assets/images/ana.webp\">\n          <img *ngIf=\"screen === 'mobile' || screen === 'tablet'\" class=\"team-figure\" src=\"../../../assets/images/ana.jpg\">\n        </div>\n  \n        <div class=\"team-body\">\n          <h5>Ana Paulo Bortolli</h5>\n        </div>\n  \n        <div class=\"team-footer\">\n          <div class=\"team-status\">Lead Interior Designer</div>\n  \n          <div class=\"team-name\">\n            <span>Ana Paula</span>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"team-right\">\n        <p>\n          Lorem ipsum aliquet taciti aenean turpis enim elit at conubia, auctor vel interdum proin nibh vel torquent condimentum, luctus euismod ad metus ut mi taciti ipsum. nunc sagittis consequat curabitur orci consectetur fermentum suscipit, litora nec integer nulla et curabitur vulputate, neque libero nullam amet vulputate malesuada. scelerisque nisl orci ultricies cras, nostra venenatis per. vel elementum fringilla lacinia nibh quisque ipsum blandit aptent nam, vestibulum tempus gravida commodo etiam duis feugiat. vehicula torquent neque urna per quisque tellus mi habitasse, nullam aenean nisl eu ultrices habitant convallis justo, duis vel integer conubia dui ultricies praesent. \n        </p>\n      </div>\n    </article>\n  </div>\n</section>\n"
